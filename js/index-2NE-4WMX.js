import{M as y}from"./index-BsYHf_FG.js";import{Z as w,B as $,q as k}from"./naive-ui-CkAFLwPC.js";import{j as C,r as s,k as o,aE as e,f as d}from"./vue-vendor-Dlp3xqCw.js";import"./vendor-N9BshxXQ.js";import"./monaco-editor-_4fVdjRp.js";import"./MonacoEditor-6_IV_tI_.js";import"./index-BpAF92W_.js";import"./vueuse-01HHsJj7.js";import"./echarts-D3LdAt7b.js";const u=`# 📝 Markdown 编辑器演示
...
| SVG 内嵌图形      |    ✅    | 支持矢量展示           |
`,A=C({name:"MarkdownEdit",setup(){const n=w(),r=s(u),t=s(!1);async function m(a,l,g=10){let c="";for(let i=0;i<a.length;i++)c+=a[i],l(c),await new Promise(h=>{setTimeout(h,g)})}const f=()=>{if(t.value)return;t.value=!0;const a=u;r.value="",m(a,l=>{r.value=l},50).then(()=>{t.value=!1})},p=o(()=>({backgroundColor:n.value.bodyColor})),v=o(()=>({backgroundColor:n.value.bodyColor,borderColor:n.value.borderColor,color:n.value.textColorBase})),b=o(()=>({backgroundColor:n.value.bodyColor,color:n.value.textColorBase})),x=o(()=>({backgroundColor:n.value.cardColor,color:n.value.textColorBase,borderColor:n.value.borderColor,position:"relative"}));return()=>e("div",{class:"h-full flex bg-gray-50",style:p.value},[e("div",{class:"w-1/3 overflow-y-auto border-r border-gray-200 p-4",style:v.value},[e("div",{class:"mb-2 text-lg font-semibold"},[d("Markdown 输入"),e($,{onClick:f,disabled:t.value,class:"ml-2"},{default:()=>[t.value?"流式渲染中...":"流式渲染"]})]),e(k,{value:r.value,type:"textarea",autosize:{minRows:20},placeholder:"请输入 Markdown 内容...",class:"w-full text-sm font-mono","onUpdate:value":a=>{r.value=a}},null)]),e("div",{class:"w-2/3 overflow-y-auto p-4",style:b.value},[e("div",{class:"mb-2 text-lg font-semibold"},[d("预览结果")]),e("div",{class:"border border-gray-200 rounded-md p-4 shadow",style:x.value},[e(y,{content:r.value,showPenEffect:t.value},null)])])])}});export{A as default};
