...
startxref
515
%%EOF`;return new Blob([t],{type:"application/pdf"})}async function El(){return(await fetch("https://www.w3schools.com/html/mov_bbb.mp4")).blob()}function Dl(){const o=new ArrayBuffer(88244),p=new DataView(o);Y(p,0,"RIFF"),p.setUint32(4,88236,!0),Y(p,8,"WAVE"),Y(p,12,"fmt "),p.setUint32(16,16,!0),p.setUint16(20,1,!0),p.setUint16(22,1,!0),p.setUint32(24,22050,!0),p.setUint32(28,44100,!0),p.setUint16(32,2,!0),p.setUint16(34,16,!0),Y(p,36,"data"),p.setUint32(40,88200,!0);for(let w=0;w<44100;w++){const z=w/22050,h=.5*(1-z/2),x=Math.sin(2*Math.PI*440*z)*h,R=Math.max(-32768,Math.min(32767,Math.floor(x*32767)));p.setInt16(44+w*2,R,!0)}return new Blob([o],{type:"audio/wav"})}function Y(t,a,l){for(let n=0;n<l.length;n++)t.setUint8(a+n,l.charCodeAt(n))}async function Sl(){const a=(await Ye(()=>import("./vendor-N9BshxXQ.js").then(n=>n.j),__vite__mapDeps([0,1,2,3,4,5]))).default,l=new a;return l.file("README.md",`# 项目说明
...
`,Pl=`<MonacoEditor
  ...
  language="typescript"
  :height="320"
/>`,Rl=`const toolbar = useMonacoEditorToolbar({
  readonly: true,
  folding: true,
  baseHeight: '320px'
});
