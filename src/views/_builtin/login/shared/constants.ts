/** 登录表单通用样式 class */
export const LOGIN_INPUT_CLASS = 'h-40px';
export const LOGIN_INPUT_FLEX_CLASS = 'h-40px flex-1';
export const LOGIN_CODE_BTN_CLASS = 'h-40px w-110px whitespace-nowrap text-12px';
