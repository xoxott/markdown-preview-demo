import{at as $}from"./index.vue_vue_type_style_index_0_lang-Dg2lAxjR.js";import{I as _,J as g,Y as B,M as z,d as I,z as y,Z as O,a0 as E,A as V,D as R,a1 as j,c as k,a2 as P,F as W,S as A,a3 as H,s as h,a4 as D,a as w,o as S,b as T,e as b,w as N,a5 as J,a6 as L,a7 as M,a8 as F,g as x,a9 as K,N as U,f as Y,B as Q,aa as X,ab as Z}from"./index-BKJWDojW.js";import"./installCanvasRenderer-DC8Qm7K1.js";import"./Space-4Ks3rbFV.js";const q=_([_("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
 ...
 `)])]),G={small:20,medium:18,large:16},ee=Object.assign(Object.assign({},R.props),{contentClass:String,contentStyle:[Object,String],description:String,stroke:String,size:{type:[String,Number],default:"medium"},show:{type:Boolean,default:!0},strokeWidth:Number,rotate:{type:Boolean,default:!0},spinning:{type:Boolean,validator:()=>!0,default:void 0},delay:Number}),te=I({name:"Spin",props:ee,slots:Object,setup(l){const{mergedClsPrefixRef:u,inlineThemeDisabled:e}=V(l),s=R("Spin","-spin",q,j,l,u),c=k(()=>{const{size:i}=l,{common:{cubicBezierEaseInOut:n},self:m}=s.value,{opacitySpinning:C,color:a,textColor:r}=m,t=typeof i=="number"?P(i):m[W("size",i)];return{"--n-bezier":n,"--n-opacity-spinning":C,"--n-size":t,"--n-color":a,"--n-text-color":r}}),d=e?A("spin",k(()=>{const{size:i}=l;return typeof i=="number"?String(i):i[0]}),c,l):void 0,f=H(l,["spinning","show"]),v=h(!1);return D(i=>{let n;if(f.value){const{delay:m}=l;if(m){n=window.setTimeout(()=>{v.value=!0},m),i(()=>{clearTimeout(n)});return}}v.value=f.value}),{mergedClsPrefix:u,active:v,mergedStrokeWidth:k(()=>{const{strokeWidth:i}=l;if(i!==void 0)return i;const{size:n}=l;return G[typeof n=="number"?"medium":n]}),cssVars:e?void 0:c,themeClass:d==null?void 0:d.themeClass,onRender:d==null?void 0:d.onRender}},render(){var l,u;const{$slots:e,mergedClsPrefix:s,description:c}=this,d=e.icon&&this.rotate,f=(c||e.description)&&y("div",{class:`${s}-spin-description`},c||((l=e.description)===null||l===void 0?void 0:l.call(e))),v=e.icon?y("div",{class:[`${s}-spin-body`,this.themeClass]},y("div",{class:[`${s}-spin`,d&&`${s}-spin--rotate`],style:e.default?"":this.cssVars},e.icon()),f):y("div",{class:[`${s}-spin-body`,this.themeClass]},y(O,{clsPrefix:s,style:e.default?"":this.cssVars,stroke:this.stroke,"stroke-width":this.mergedStrokeWidth,class:`${s}-spin`}),f);return(u=this.onRender)===null||u===void 0||u.call(this),e.default?y("div",{class:[`${s}-spin-container`,this.themeClass],style:this.cssVars},y("div",{class:[`${s}-spin-content`,this.active&&`${s}-spin-content--spinning`,this.contentClass],style:this.contentStyle},e),y(E,{name:"fade-in-transition"},{default:()=>this.active?v:null})):v}});async function se(l,u,e="openChat",s={}){try{const c=new AbortController,d=s.timeout?setTimeout(()=>c.abort(),s.timeout):null,f=await fetch("http://localhost:11434/api/generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:e,prompt:l,stream:!0}),signal:s.signal||c.signal});if(!f.ok)throw new Error(`请求失败: ${f.status} ${f.statusText}`);if(!f.body)throw new Error("响应体不可读");const v=f.body.getReader(),i=new TextDecoder("utf-8");let n="",m=!1;await(async()=>{try{for(;!m;){const{done:a,value:r}=await v.read();if(a){if(m=!0,n.trim())try{const o=JSON.parse(n);o.response&&u(o.response)}catch(o){console.warn("流结束时的缓冲区解析失败:",n,o)}break}n+=i.decode(r,{stream:!0});const t=n.split(`
